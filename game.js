...
const RPG = (() => {
  ...
  const DRAGON_CARDS = [
    ...
    { id:'dc_ignis_r1',    dragon:'ignis',   type:'offensiva', rarity:'raro',        name:'Ruggito Infuocato',         icon:'🌋', atk:6, def:2, heal:2, desc:'6 danni, assorbe 2 e recupera 2 HP.' },
    { id:'dc_ignis_r2',    dragon:'ignis',   type:'offensiva', rarity:'raro',        name:'Esplosione Solare',         icon:'🌋', atk:5, def:3, heal:2, desc:'5 danni, assorbe 3 e recupera 2 HP.' },
    { id:'dc_ignis_e1',    dragon:'ignis',   type:'offensiva', rarity:'epico',       name:'Nova Cremante',             icon:'💥', atk:7, def:3, heal:4, effect:'burn', effectVal:2, desc:'7 danni + 2 bruciatura per 2 turni. Assorbe 3 e recupera 4 HP.' },
    { id:'dc_ignis_e2',    dragon:'ignis',   type:'offensiva', rarity:'epico',       name:'Tempesta di Fuoco',         icon:'💥', atk:8, def:4, heal:2, desc:'8 danni devastanti, assorbe 4 e recupera 2 HP.' },
    { id:'dc_ignis_l1',    dragon:'ignis',   type:'offensiva', rarity:'leggendario', name:'Eruzione del Drago Eterno', icon:'🌋', atk:11, def:5, heal:4, effect:'burn', effectVal:4, desc:'11 danni + 4 bruciatura per 2 turni. Assorbe 5 e recupera 4 HP.' },
    { id:'dc_ignis_l2',    dragon:'ignis',   type:'offensiva', rarity:'leggendario', name:'Apocalisse di Cenere',      icon:'💥', atk:8, def:6, heal:6, effect:'double', desc:'8 danni due volte + bruciatura su entrambi i colpi. Assorbe 6 e recupera 6 HP.' },
    // ── AQUA — drago dell'acqua (difensivo) — budget: C=6 NC=8 R=11 E=15 L=21
    { id:'dc_aqua_c1',     dragon:'aqua',    type:'difensiva', rarity:'comune',      name:'Scudo d\'Acqua',            icon:'🛡️', atk:1, def:4, heal:1, desc:'Assorbe 4 danni, infligge 1 e recupera 1 HP.' },
    { id:'dc_aqua_c2',     dragon:'aqua',    type:'difensiva', rarity:'comune',      name:'Goccia Curativa',           icon:'💧', atk:1, def:1, heal:4, desc:'Recupera 4 HP, infligge 1 e assorbe 1.' },
    { id:'dc_aqua_nc1',    dragon:'aqua',    type:'difensiva', rarity:'non_comune',  name:'Bolla Protettiva',          icon:'💧', atk:1, def:4, heal:3, desc:'Assorbe 4 danni e recupera 3 HP.' },
    { id:'dc_aqua_nc2',    dragon:'aqua',    type:'difensiva', rarity:'non_comune',  name:'Corrente Fredda',           icon:'💧', atk:1, def:2, heal:5, desc:'Recupera 5 HP e assorbe 2 danni.' },
    { id:'dc_aqua_r1',     dragon:'aqua',    type:'difensiva', rarity:'raro',        name:'Marea Protettiva',          icon:'🌊', atk:2, def:5, heal:4, desc:'Assorbe 5 danni e recupera 4 HP.' },
    { id:'dc_aqua_r2',     dragon:'aqua',    type:'difensiva', rarity:'raro',        name:'Onda Purificante',          icon:'🌊', atk:2, def:2, heal:7, effect:'cleanse', desc:'Recupera 7 HP, assorbe 2 e rimuove tutti gli effetti negativi.' },
    { id:'dc_aqua_e1',     dragon:'aqua',    type:'difensiva', rarity:'epico',       name:'Vortice Guaritore',         icon:'💎', atk:2, def:6, heal:7, desc:'Assorbe 6 danni e recupera 7 HP.' },
    { id:'dc_aqua_e2',     dragon:'aqua',    type:'difensiva', rarity:'epico',       name:'Scudo Abissale',            icon:'💎', atk:2, def:11, heal:2, desc:'Assorbe 11 danni, infligge 2 e recupera 2 HP.' },
    { id:'dc_aqua_l1',     dragon:'aqua',    type:'difensiva', rarity:'leggendario', name:'Diluvio Rigenerante',       icon:'🌊', atk:3, def:9, heal:9, effect:'shield', desc:'Assorbe 9 danni, recupera 9 HP e crea uno scudo per il turno successivo.' },
    { id:'dc_aqua_l2',     dragon:'aqua',    type:'difensiva', rarity:'leggendario', name:'Oceano Immortale',          icon:'💎', atk:3, def:5, heal:13, effect:'revive', desc:'Recupera 13 HP e assorbe 5. Se sconfitto questo turno, sopravvivi con 1 HP.' },
    // ── SILVANO — drago della foresta (supporto) — budget: C=5 NC=7 R=10 E=14 L=20
    { id:'dc_silvano_c1',  dragon:'silvano', type:'supporto',  rarity:'comune',      name:'Vento Verde',               icon:'🌿', atk:1, def:1, heal:3, desc:'Recupera 3 HP, infligge 1 e assorbe 1.' },
    { id:'dc_silvano_c2',  dragon:'silvano', type:'supporto',  rarity:'comune',      name:'Foglia Guida',              icon:'🍃', atk:1, def:2, heal:2, effect:'draw', effectVal:1, desc:'Pesca 1 carta. Assorbe 2 e recupera 2 HP.' },
    { id:'dc_silvano_nc1', dragon:'silvano', type:'supporto',  rarity:'non_comune',  name:'Spore Curative',            icon:'🍃', atk:1, def:2, heal:4, desc:'Recupera 4 HP, assorbe 2 e infligge 1.' },
    { id:'dc_silvano_nc2', dragon:'silvano', type:'supporto',  rarity:'non_comune',  name:'Intrico Radicale',          icon:'🌿', atk:2, def:1, heal:4, desc:'2 danni e recupera 4 HP. Assorbe 1.' },
    { id:'dc_silvano_r1',  dragon:'silvano', type:'supporto',  rarity:'raro',        name:'Linfa Vitale',              icon:'🌳', atk:2, def:2, heal:6, desc:'2 danni, recupera 6 HP e assorbe 2.' },
    { id:'dc_silvano_r2',  dragon:'silvano', type:'supporto',  rarity:'raro',        name:'Rigenerazione Boschiva',    icon:'🌳', atk:1, def:3, heal:6, effect:'draw', effectVal:1, desc:'Recupera 6 HP, assorbe 3 e pesca 1 carta.' },
    { id:'dc_silvano_e1',  dragon:'silvano', type:'supporto',  rarity:'epico',       name:'Fioritura Eterna',          icon:'🌸', atk:2, def:4, heal:8, effect:'draw', effectVal:2, desc:'Pesca 2 carte extra. Recupera 8 HP e assorbe 4.' },
    { id:'dc_silvano_e2',  dragon:'silvano', type:'supporto',  rarity:'epico',       name:'Guarigione del Grande Albero',icon:'🌸', atk:2, def:4, heal:8, desc:'Recupera 8 HP e assorbe 4 danni.' },
    { id:'dc_silvano_l1',  dragon:'silvano', type:'supporto',  rarity:'leggendario', name:'Rinascita del Grande Bosco', icon:'🌲', atk:4, def:6, heal:10, effect:'draw', effectVal:2, desc:'4 danni, recupera 10 HP, assorbe 6 e pesca 2 carte.' },
    { id:'dc_silvano_l2',  dragon:'silvano', type:'supporto',  rarity:'leggendario', name:'Spirito della Foresta',     icon:'🌲', atk:3, def:8, heal:9, effect:'draw', effectVal:3, desc:'Recupera 9 HP, assorbe 8 danni e pesca 3 carte.' },
    // ── TERRAS — drago della terra (difensivo/offensivo) — budget: C=6 NC=8 R=11 E=15 L=21
    { id:'dc_terras_c1',   dragon:'terras',  type:'difensiva', rarity:'comune',      name:'Muro di Roccia',            icon:'🪨', atk:1, def:4, heal:1, desc:'Assorbe 4 danni, infligge 1 e recupera 1 HP.' },
    { id:'dc_terras_c2',   dragon:'terras',  type:'offensiva', rarity:'comune',      name:'Polvere di Pietra',         icon:'🪨', atk:3, def:2, heal:1, desc:'3 danni, assorbe 2 e recupera 1 HP.' },
    { id:'dc_terras_nc1',  dragon:'terras',  type:'difensiva', rarity:'non_comune',  name:'Scudo di Granito',          icon:'🪨', atk:1, def:5, heal:2, desc:'Assorbe 5 danni e recupera 2 HP.' },
    { id:'dc_terras_nc2',  dragon:'terras',  type:'offensiva', rarity:'non_comune',  name:'Impatto Tellurico',         icon:'⛏️', atk:4, def:2, heal:2, desc:'4 danni, assorbe 2 e recupera 2 HP.' },
    { id:'dc_terras_r1',   dragon:'terras',  type:'offensiva', rarity:'raro',        name:'Pugno di Terra',            icon:'⛏️', atk:5, def:4, heal:2, desc:'5 danni, assorbe 4 e recupera 2 HP.' },
    { id:'dc_terras_r2',   dragon:'terras',  type:'difensiva', rarity:'raro',        name:'Terremoto Minore',          icon:'🏔️', atk:4, def:5, heal:2, desc:'4 danni, assorbe 5 e recupera 2 HP.' },
    { id:'dc_terras_e1',   dragon:'terras',  type:'difensiva', rarity:'epico',       name:'Fortezza Ancestrale',       icon:'🏔️', atk:2, def:10, heal:3, desc:'Assorbe 10 danni. Infligge 2 e recupera 3 HP.' },
    { id:'dc_terras_e2',   dragon:'terras',  type:'offensiva', rarity:'epico',       name:'Valanga',                   icon:'⛏️', atk:7, def:4, heal:4, effect:'stun', desc:'7 danni, assorbe 4 e recupera 4 HP. Stordisce il nemico per un turno.' },
    { id:'dc_terras_l1',   dragon:'terras',  type:'difensiva', rarity:'leggendario', name:'Colosso di Pietra Eterna',  icon:'🏔️', atk:4, def:13, heal:4, effect:'taunt', desc:'4 danni, assorbe 13 e recupera 4 HP. Forza il nemico ad attaccare per un turno.' },
    { id:'dc_terras_l2',   dragon:'terras',  type:'offensiva', rarity:'leggendario', name:'Apocalisse Geologica',      icon:'⛏️', atk:9, def:8, heal:4, desc:'9 danni, assorbe 8 e recupera 4 HP.' },
    // ── GLACIO — drago del ghiaccio (offensivo/control) — budget: C=5 NC=7 R=10 E=14 L=20
    { id:'dc_glacio_c1',   dragon:'glacio',  type:'offensiva', rarity:'comune',      name:'Lama di Ghiaccio',          icon:'❄️', atk:3, def:1, heal:1, effect:'freeze', effectVal:1, desc:'3 danni. Il nemico perde 1 difesa. Assorbe 1 e recupera 1 HP.' },
    { id:'dc_glacio_c2',   dragon:'glacio',  type:'offensiva', rarity:'comune',      name:'Cristallo Pungente',        icon:'🧊', atk:3, def:1, heal:1, desc:'3 danni, assorbe 1 e recupera 1 HP.' },
    { id:'dc_glacio_nc1',  dragon:'glacio',  type:'offensiva', rarity:'non_comune',  name:'Freccia Glaciale',          icon:'🧊', atk:4, def:2, heal:1, desc:'4 danni, assorbe 2 e recupera 1 HP.' },
    { id:'dc_glacio_nc2',  dragon:'glacio',  type:'difensiva', rarity:'non_comune',  name:'Nebbia Gelida',             icon:'❄️', atk:1, def:4, heal:2, effect:'freeze', effectVal:1, desc:'Assorbe 4 danni. Il nemico perde 1 difesa. Recupera 2 HP.' },
    { id:'dc_glacio_r1',   dragon:'glacio',  type:'offensiva', rarity:'raro',        name:'Tempesta Glaciale',         icon:'🌨️', atk:5, def:3, heal:2, effect:'freeze', effectVal:2, desc:'5 danni, assorbe 3 e recupera 2 HP. Il nemico perde 2 difesa.' },
    { id:'dc_glacio_r2',   dragon:'glacio',  type:'offensiva', rarity:'raro',        name:'Lancia di Ghiaccio',        icon:'🧊', atk:6, def:2, heal:2, desc:'6 danni, assorbe 2 e recupera 2 HP.' },
    { id:'dc_glacio_e1',   dragon:'glacio',  type:'offensiva', rarity:'epico',       name:'Congelamento Totale',       icon:'🧊', atk:6, def:4, heal:4, effect:'stun', desc:'6 danni, assorbe 4 e recupera 4 HP. Il nemico salta il prossimo turno.' },
    { id:'dc_glacio_e2',   dragon:'glacio',  type:'offensiva', rarity:'epico',       name:'Tormenta Eterna',           icon:'🌨️', atk:7, def:5, heal:2, effect:'freeze', effectVal:2, desc:'7 danni, assorbe 5 e recupera 2 HP. Abbassa 2 difesa nemica.' },
    { id:'dc_glacio_l1',   dragon:'glacio',  type:'offensiva', rarity:'leggendario', name:'Era Glaciale',              icon:'❄️', atk:9, def:6, heal:5, effect:'stun', desc:'9 danni, assorbe 6 e recupera 5 HP. Stordisce il nemico per 2 turni.' },
    { id:'dc_glacio_l2',   dragon:'glacio',  type:'offensiva', rarity:'leggendario', name:'Assoluto Zero',             icon:'🧊', atk:11, def:5, heal:4, effect:'freeze', effectVal:5, desc:'11 danni, assorbe 5 e recupera 4 HP. Azzera la difesa nemica per 2 turni.' },
    // ── VOLT — drago del fulmine (offensivo/veloce) — budget: C=6 NC=8 R=11 E=14 L=20
    { id:'dc_volt_c1',     dragon:'volt',    type:'offensiva', rarity:'comune',      name:'Scintilla',                 icon:'⚡', atk:4, def:1, heal:1, desc:'4 danni, assorbe 1 e recupera 1 HP.' },
    { id:'dc_volt_c2',     dragon:'volt',    type:'offensiva', rarity:'comune',      name:'Scosse Statiche',           icon:'⚡', atk:3, def:2, heal:1, effect:'chain', desc:'3 danni che rimbalzano per 1 danno extra. Assorbe 2 e recupera 1 HP.' },
    { id:'dc_volt_nc1',    dragon:'volt',    type:'offensiva', rarity:'non_comune',  name:'Elettroschoc',              icon:'⚡', atk:4, def:2, heal:2, effect:'stun', desc:'4 danni, assorbe 2 e recupera 2 HP. 50% di stordire il nemico.' },
    { id:'dc_volt_nc2',    dragon:'volt',    type:'offensiva', rarity:'non_comune',  name:'Scarica Rapida',            icon:'⚡', atk:5, def:2, heal:1, desc:'5 danni con priorità (va prima del nemico). Assorbe 2 e recupera 1 HP.' },
    { id:'dc_volt_r1',     dragon:'volt',    type:'offensiva', rarity:'raro',        name:'Fulmine Diretto',           icon:'🌩️', atk:7, def:2, heal:2, desc:'7 danni, assorbe 2 e recupera 2 HP.' },
    { id:'dc_volt_r2',     dragon:'volt',    type:'offensiva', rarity:'raro',        name:'Tempesta Elettrica',        icon:'🌩️', atk:5, def:3, heal:3, effect:'double', desc:'5 danni due volte. Assorbe 3 e recupera 3 HP.' },
    { id:'dc_volt_e1',     dragon:'volt',    type:'offensiva', rarity:'epico',       name:'Scarica Sovraccarica',      icon:'🔋', atk:6, def:4, heal:4, effect:'double', desc:'6 danni due volte. Il secondo colpo ignora la difesa. Assorbe 4 e recupera 4 HP.' },
    { id:'dc_volt_e2',     dragon:'volt',    type:'offensiva', rarity:'epico',       name:'Arco Voltaico',             icon:'⚡', atk:7, def:4, heal:3, effect:'chain', desc:'7 danni che rimbalzano infliggendo 4 danni extra. Assorbe 4 e recupera 3 HP.' },
    { id:'dc_volt_l1',     dragon:'volt',    type:'offensiva', rarity:'leggendario', name:'Tempesta Suprema',          icon:'🌩️', atk:9, def:5, heal:6, effect:'chain', desc:'9 danni che rimbalzano tre volte. Assorbe 5 e recupera 6 HP.' },
    { id:'dc_volt_l2',     dragon:'volt',    type:'offensiva', rarity:'leggendario', name:'Dio del Tuono',             icon:'🔋', atk:8, def:6, heal:6, effect:'double+stun', desc:'8 danni due volte. Stordisce il nemico dopo il secondo colpo. Assorbe 6 e recupera 6 HP.' },
    // ── UMBRA — drago dell'ombra (control/supporto) — budget: C=5 NC=7 R=10 E=14 L=20
    { id:'dc_umbra_c1',    dragon:'umbra',   type:'difensiva', rarity:'comune',      name:'Velo Oscuro',               icon:'🌑', atk:1, def:3, heal:1, desc:'Assorbe 3 danni, infligge 1 e recupera 1 HP.' },
    { id:'dc_umbra_c2',    dragon:'umbra',   type:'supporto',  rarity:'comune',      name:'Sussurro delle Ombre',      icon:'🌑', atk:2, def:2, heal:1, desc:'2 danni, assorbe 2 e recupera 1 HP.' },
    { id:'dc_umbra_nc1',   dragon:'umbra',   type:'supporto',  rarity:'non_comune',  name:'Tocco d\'Ombra',            icon:'🌑', atk:3, def:2, heal:2, desc:'3 danni, assorbe 2 e recupera 2 HP.' },
    { id:'dc_umbra_nc2',   dragon:'umbra',   type:'supporto',  rarity:'non_comune',  name:'Nebbia Oscura',             icon:'🌑', atk:1, def:4, heal:2, effect:'blind', desc:'Assorbe 4 danni, recupera 2 HP. Il nemico manca il prossimo attacco.' },
    { id:'dc_umbra_r1',    dragon:'umbra',   type:'supporto',  rarity:'raro',        name:'Drenaggio Vitale',          icon:'🕷️', atk:4, def:2, heal:4, desc:'4 danni, assorbe 2 e recupera 4 HP.' },
    { id:'dc_umbra_r2',    dragon:'umbra',   type:'offensiva', rarity:'raro',        name:'Lama d\'Ombra',             icon:'👁️', atk:5, def:3, heal:2, desc:'5 danni, assorbe 3 e recupera 2 HP.' },
    { id:'dc_umbra_e1',    dragon:'umbra',   type:'supporto',  rarity:'epico',       name:'Furto di Potere',           icon:'👁️', atk:4, def:4, heal:6, effect:'steal', desc:'4 danni, assorbe 4 e recupera 6 HP. Ruba 1 carta dalla mano nemica.' },
    { id:'dc_umbra_e2',    dragon:'umbra',   type:'supporto',  rarity:'epico',       name:'Cancellazione Oscura',      icon:'🕷️', atk:5, def:4, heal:5, effect:'steal', desc:'5 danni, assorbe 4 e recupera 5 HP. Ruba 1 carta.' },
    { id:'dc_umbra_l1',    dragon:'umbra',   type:'supporto',  rarity:'leggendario', name:'Sovrano delle Ombre',       icon:'👁️', atk:7, def:6, heal:7, effect:'steal', desc:'7 danni, assorbe 6 e recupera 7 HP. Ruba 2 carte dalla mano nemica.' },
    { id:'dc_umbra_l2',    dragon:'umbra',   type:'supporto',  rarity:'leggendario', name:'Abisso Divorante',          icon:'🌑', atk:8, def:7, heal:5, effect:'blind+steal', desc:'8 danni, assorbe 7 e recupera 5 HP. Acceca il nemico e ruba 1 carta.' },
    // ── CHRONOS — drago del tempo (control) — budget: C=5 NC=7 R=10 E=14 L=20
    { id:'dc_chronos_c1',  dragon:'chronos', type:'supporto',  rarity:'comune',      name:'Rallentamento',             icon:'⏳', atk:1, def:2, heal:2, effect:'slow', desc:'Assorbe 2 danni e recupera 2 HP. Il nemico perde 1 azione al prossimo turno.' },
    { id:'dc_chronos_c2',  dragon:'chronos', type:'difensiva', rarity:'comune',      name:'Pausa Momentanea',          icon:'⌛', atk:1, def:3, heal:1, effect:'slow', desc:'Assorbe 3 danni e recupera 1 HP. Rallenta il nemico.' },
    { id:'dc_chronos_nc1', dragon:'chronos', type:'supporto',  rarity:'non_comune',  name:'Distorsione',               icon:'⌛', atk:2, def:3, heal:2, desc:'2 danni, assorbe 3 e recupera 2 HP.' },
    { id:'dc_chronos_nc2', dragon:'chronos', type:'supporto',  rarity:'non_comune',  name:'Accelerazione',             icon:'⏳', atk:3, def:2, heal:2, effect:'draw', effectVal:1, desc:'3 danni, assorbe 2 e recupera 2 HP. Pesca 1 carta.' },
    { id:'dc_chronos_r1',  dragon:'chronos', type:'supporto',  rarity:'raro',        name:'Riavvolgimento',            icon:'🔄', atk:2, def:4, heal:4, effect:'rewind', desc:'Assorbe 4 danni e recupera 4 HP. Riprendi l\'ultima carta giocata.' },
    { id:'dc_chronos_r2',  dragon:'chronos', type:'supporto',  rarity:'raro',        name:'Salto Temporale',           icon:'⌛', atk:2, def:4, heal:4, effect:'extra_turn', desc:'Assorbe 4 danni e recupera 4 HP. Gioca un\'altra carta subito dopo questa.' },
    { id:'dc_chronos_e1',  dragon:'chronos', type:'supporto',  rarity:'epico',       name:'Doppio Turno',              icon:'⌛', atk:3, def:5, heal:6, effect:'extra_turn', desc:'Assorbe 5 danni e recupera 6 HP. Gioca due carte extra questo turno.' },
    { id:'dc_chronos_e2',  dragon:'chronos', type:'supporto',  rarity:'epico',       name:'Paradosso',                 icon:'🔄', atk:3, def:6, heal:5, effect:'rewind+draw', effectVal:2, desc:'Assorbe 6 danni e recupera 5 HP. Riprendi l\'ultima carta giocata e pesca 2 carte.' },
    { id:'dc_chronos_l1',  dragon:'chronos', type:'supporto',  rarity:'leggendario', name:'Padrone del Tempo',         icon:'⏳', atk:4, def:8, heal:8, effect:'time_stop', effectVal:2, desc:'Assorbe 8 danni e recupera 8 HP. Il nemico salta 2 turni. Tu peschi 3 carte.' },
    { id:'dc_chronos_l2',  dragon:'chronos', type:'supporto',  rarity:'leggendario', name:'Singolarità Temporale',     icon:'🔄', atk:4, def:9, heal:7, effect:'time_stop+rewind', desc:'Assorbe 9 danni e recupera 7 HP. Nemico salta 2 turni. Riprendi tutte le carte giocate.' },
    // ── LUX — drago della luce (supporto/sacro) — budget: C=5 NC=7 R=10 E=14 L=20
    { id:'dc_lux_c1',      dragon:'lux',     type:'supporto',  rarity:'comune',      name:'Raggio di Sole',            icon:'☀️', atk:1, def:1, heal:3, desc:'Recupera 3 HP, assorbe 1 e infligge 1.' },
    { id:'dc_lux_c2',      dragon:'lux',     type:'offensiva', rarity:'comune',      name:'Scintilla Sacra',           icon:'✨', atk:3, def:1, heal:1, desc:'3 danni sacri, assorbe 1 e recupera 1 HP.' },
    { id:'dc_lux_nc1',     dragon:'lux',     type:'supporto',  rarity:'non_comune',  name:'Benedizione',               icon:'✨', atk:1, def:2, heal:4, desc:'Recupera 4 HP e assorbe 2 danni.' },
    { id:'dc_lux_nc2',     dragon:'lux',     type:'offensiva', rarity:'non_comune',  name:'Lampo Accecante',           icon:'☀️', atk:3, def:2, heal:2, effect:'blind', desc:'3 danni sacri, assorbe 2 e recupera 2 HP. Il nemico manca il prossimo attacco.' },
    { id:'dc_lux_r1',      dragon:'lux',     type:'supporto',  rarity:'raro',        name:'Guarigione Divina',         icon:'✨', atk:2, def:2, heal:6, desc:'Recupera 6 HP e assorbe 2 danni.' },
    { id:'dc_lux_r2',      dragon:'lux',     type:'offensiva', rarity:'raro',        name:'Lancia di Luce',            icon:'☀️', atk:6, def:2, heal:2, desc:'6 danni sacri che ignorano la difesa. Assorbe 2 e recupera 2 HP.' },
    { id:'dc_lux_e1',      dragon:'lux',     type:'supporto',  rarity:'epico',       name:'Rinascita della Fenice',    icon:'✨', atk:3, def:3, heal:8, effect:'revive', desc:'Recupera 8 HP e assorbe 3 danni. 50% di sopravvivere a un KO questo turno.' },
    { id:'dc_lux_e2',      dragon:'lux',     type:'offensiva', rarity:'epico',       name:'Giudizio Solare',           icon:'☀️', atk:8, def:3, heal:3, effect:'cleanse', desc:'8 danni sacri, assorbe 3 e recupera 3 HP. Rimuove tutti gli effetti negativi.' },
    { id:'dc_lux_l1',      dragon:'lux',     type:'supporto',  rarity:'leggendario', name:'Sole Eterno',               icon:'☀️', atk:5, def:5, heal:10, effect:'blind', desc:'5 danni sacri, assorbe 5 e recupera 10 HP. Acceca il nemico per 2 turni.' },
    { id:'dc_lux_l2',      dragon:'lux',     type:'supporto',  rarity:'leggendario', name:'Avatara della Luce',        icon:'✨', atk:6, def:7, heal:7, effect:'revive', desc:'6 danni sacri, assorbe 7 e recupera 7 HP. Sopravvivi al prossimo KO.' },
    // ── AERO — drago del vento (agile/control) — budget: C=6 NC=8 R=11 E=15 L=21
    { id:'dc_aero_c1',     dragon:'aero',    type:'offensiva', rarity:'comune',      name:'Raffica',                   icon:'💨', atk:4, def:1, heal:1, desc:'4 danni, assorbe 1 e recupera 1 HP.' },
    { id:'dc_aero_c2',     dragon:'aero',    type:'supporto',  rarity:'comune',      name:'Vento Curativo',            icon:'💨', atk:1, def:2, heal:3, desc:'Recupera 3 HP, assorbe 2 e infligge 1.' },
    { id:'dc_aero_nc1',    dragon:'aero',    type:'offensiva', rarity:'non_comune',  name:'Tornado Minore',            icon:'🌪️', atk:4, def:2, heal:2, effect:'discard', desc:'4 danni, assorbe 2 e recupera 2 HP. Il nemico scarta 1 carta a caso.' },
    { id:'dc_aero_nc2',    dragon:'aero',    type:'supporto',  rarity:'non_comune',  name:'Corrente Ascensionale',     icon:'💨', atk:1, def:3, heal:4, effect:'draw', effectVal:2, desc:'Recupera 4 HP, assorbe 3 e pesca 2 carte.' },
    { id:'dc_aero_r1',     dragon:'aero',    type:'offensiva', rarity:'raro',        name:'Turbine Tagliente',         icon:'🌪️', atk:5, def:3, heal:3, effect:'double', desc:'5 danni due volte (sempre per primo). Assorbe 3 e recupera 3 HP.' },
    { id:'dc_aero_r2',     dragon:'aero',    type:'difensiva', rarity:'raro',        name:'Barriera di Vento',         icon:'💨', atk:2, def:6, heal:3, desc:'Assorbe 6 danni, infligge 2 e recupera 3 HP.' },
    { id:'dc_aero_e1',     dragon:'aero',    type:'offensiva', rarity:'epico',       name:'Occhio del Ciclone',        icon:'🌪️', atk:5, def:6, heal:4, effect:'discard', desc:'5 danni, assorbe 6 e recupera 4 HP. Il nemico scarta 1 carta.' },
    { id:'dc_aero_e2',     dragon:'aero',    type:'offensiva', rarity:'epico',       name:'Tempesta di Lame',          icon:'💨', atk:6, def:4, heal:5, effect:'double+chain', desc:'6 danni due volte che rimbalzano per 2 extra ciascuno. Assorbe 4 e recupera 5 HP.' },
    { id:'dc_aero_l1',     dragon:'aero',    type:'offensiva', rarity:'leggendario', name:'Grande Uragano',            icon:'🌪️', atk:9, def:6, heal:6, effect:'discard+stun', desc:'9 danni, assorbe 6 e recupera 6 HP. Il nemico scarta 2 carte e salta il prossimo turno.' },
    { id:'dc_aero_l2',     dragon:'aero',    type:'supporto',  rarity:'leggendario', name:'Dio del Cielo',             icon:'💨', atk:7, def:7, heal:7, effect:'draw', effectVal:3, desc:'7 danni, assorbe 7 e recupera 7 HP. Pesca 3 carte. L\'equilibrio supremo.' },
  ];
