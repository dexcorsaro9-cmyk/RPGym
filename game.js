...
const RPG = (() => {
  ...
  const CAMP_LAYERS = [
    ...
    { id: 'tent_small',    stage: 0, minLevel: 6,  left: 10, bottom: 8,  width: 32, z: 9  },
    { id: 'banner_worn',   stage: 0, minLevel: 8,  left: 74, bottom: 12, width: 12, z: 7  },
    // ── Stage 1: Avamposto ──
    { id: 'log_cabin',     stage: 1, minLevel: 10, left: 16, bottom: 8,  width: 42, z: 12 },
    { id: 'stockade',      stage: 1, minLevel: 12, left: 60, bottom: 5,  width: 34, z: 9  },
    { id: 'blacksmith',    stage: 1, minLevel: 14, left: 68, bottom: 8,  width: 26, z: 11 },
    { id: 'well',          stage: 1, minLevel: 16, left: 45, bottom: 5,  width: 14, z: 8  },
    { id: 'watchtower_s',  stage: 1, minLevel: 18, left: 2,  bottom: 12, width: 20, z: 13 },
    // ── Stage 2: Rifugio ──
    { id: 'stone_hall',    stage: 2, minLevel: 20, left: 18, bottom: 10, width: 48, z: 14 },
    { id: 'stable',        stage: 2, minLevel: 22, left: 64, bottom: 8,  width: 28, z: 12 },
    { id: 'forge',         stage: 2, minLevel: 24, left: 4,  bottom: 8,  width: 22, z: 11 },
    { id: 'market_stall',  stage: 2, minLevel: 26, left: 52, bottom: 5,  width: 20, z: 10 },
    ...
    { id: 'keep',          stage: 3, minLevel: 32, left: 26, bottom: 12, width: 52, z: 16 },
    { id: 'armory',        stage: 3, minLevel: 34, left: 2,  bottom: 10, width: 26, z: 14 },
    { id: 'library',       stage: 3, minLevel: 36, left: 68, bottom: 10, width: 26, z: 14 },
    { id: 'siege_engine',  stage: 3, minLevel: 38, left: 50, bottom: 4,  width: 26, z: 13 },
    // ── Stage 4: Cittadella ──
    { id: 'citadel',       stage: 4, minLevel: 40, left: 14, bottom: 15, width: 60, z: 18 },
    { id: 'arcane_tower',  stage: 4, minLevel: 42, left: 68, bottom: 18, width: 24, z: 17 },
    { id: 'barracks',      stage: 4, minLevel: 44, left: 1,  bottom: 8,  width: 28, z: 15 },
    { id: 'monument',      stage: 4, minLevel: 46, left: 43, bottom: 5,  width: 18, z: 16 },
    { id: 'dragon_banner', stage: 4, minLevel: 48, left: 35, bottom: 36, width: 14, z: 20 },
    /* ── Stage 5: Leggenda (lv 50–58) ── */
    { id: 'throne_hall',    stage: 5, minLevel: 50, left: 12, bottom: 12, width: 66, z: 22 },
    { id: 'colosseum',      stage: 5, minLevel: 52, left: 64, bottom: 6,  width: 34, z: 20 },
    { id: 'triumphal_arch', stage: 5, minLevel: 54, left: 33, bottom: 0,  width: 24, z: 25 },
    { id: 'grand_obelisk',  stage: 5, minLevel: 56, left: 2,  bottom: 5,  width: 14, z: 18 },
    { id: 'celestial_beacon', stage: 5, minLevel: 58, left: 74, bottom: 20, width: 18, z: 24 },
  ];
