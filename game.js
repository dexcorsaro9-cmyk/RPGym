...
const RPG = (() => {
  ...
  const CAMP_LAYERS = [
    ...
    { id: 'campfire',      stage: 0, minLevel: 0,  left: 45, bottom: 8,  width: 14, z: 10 },
    { id: 'bedroll',       stage: 0, minLevel: 2,  left: 28, bottom: 4,  width: 14, z: 8  },
    { id: 'supply_sack',   stage: 0, minLevel: 4,  left: 65, bottom: 5,  width: 11, z: 8  },
    { id: 'tent_small',    stage: 0, minLevel: 6,  left: 12, bottom: 8,  width: 22, z: 9  },
    { id: 'banner_worn',   stage: 0, minLevel: 8,  left: 74, bottom: 12, width: 8,  z: 7  },
    // ── Stage 1: Avamposto ──
    { id: 'log_cabin',     stage: 1, minLevel: 10, left: 18, bottom: 8,  width: 30, z: 12 },
    { id: 'stockade',      stage: 1, minLevel: 12, left: 63, bottom: 5,  width: 24, z: 9  },
    { id: 'blacksmith',    stage: 1, minLevel: 14, left: 70, bottom: 8,  width: 18, z: 11 },
    { id: 'well',          stage: 1, minLevel: 16, left: 46, bottom: 5,  width: 10, z: 8  },
    { id: 'watchtower_s',  stage: 1, minLevel: 18, left: 4,  bottom: 12, width: 14, z: 13 },
    // ── Stage 2: Rifugio ──
    { id: 'stone_hall',    stage: 2, minLevel: 20, left: 20, bottom: 10, width: 34, z: 14 },
    { id: 'stable',        stage: 2, minLevel: 22, left: 66, bottom: 8,  width: 20, z: 12 },
    { id: 'forge',         stage: 2, minLevel: 24, left: 6,  bottom: 8,  width: 16, z: 11 },
    { id: 'market_stall',  stage: 2, minLevel: 26, left: 54, bottom: 5,  width: 14, z: 10 },
    { id: 'banner_guild',  stage: 2, minLevel: 28, left: 37, bottom: 22, width: 8,  z: 15 },
    // ── Stage 3: Fortilizio ──
    { id: 'fortress_wall', stage: 3, minLevel: 30, left: 0,  bottom: 0,  width: 100, z: 6 },
    { id: 'keep',          stage: 3, minLevel: 32, left: 28, bottom: 12, width: 38, z: 16 },
    { id: 'armory',        stage: 3, minLevel: 34, left: 4,  bottom: 10, width: 18, z: 14 },
    { id: 'library',       stage: 3, minLevel: 36, left: 70, bottom: 10, width: 18, z: 14 },
    { id: 'siege_engine',  stage: 3, minLevel: 38, left: 52, bottom: 4,  width: 18, z: 13 },
    // ── Stage 4: Cittadella ──
    { id: 'citadel',       stage: 4, minLevel: 40, left: 16, bottom: 15, width: 44, z: 18 },
    { id: 'arcane_tower',  stage: 4, minLevel: 42, left: 70, bottom: 18, width: 16, z: 17 },
    { id: 'barracks',      stage: 4, minLevel: 44, left: 2,  bottom: 8,  width: 20, z: 15 },
    { id: 'monument',      stage: 4, minLevel: 46, left: 44, bottom: 5,  width: 12, z: 16 },
    { id: 'dragon_banner', stage: 4, minLevel: 48, left: 36, bottom: 36, width: 10, z: 20 },
    /* ── Stage 5: Leggenda (lv 50–58) ── */
    { id: 'throne_hall',    stage: 5, minLevel: 50, left: 14, bottom: 12, width: 48, z: 22 },
    { id: 'colosseum',      stage: 5, minLevel: 52, left: 66, bottom: 6,  width: 24, z: 20 },
    { id: 'triumphal_arch', stage: 5, minLevel: 54, left: 34, bottom: 0,  width: 16, z: 25 },
    { id: 'grand_obelisk',  stage: 5, minLevel: 56, left: 4,  bottom: 5,  width: 8,  z: 18 },
    { id: 'celestial_beacon', stage: 5, minLevel: 58, left: 76, bottom: 20, width: 12, z: 24 },
  ];
  ...
  const FURNITURE_SETS = [
    ...
    },
    {
      ...
      items: [
        {id: "f071", name: "Lastra di Sabbia Cinerea", bonusText: "+1 Stamina", epic: false, wall: false, effects: [{"type": "staminaMax", "value": 1.0}], price: {"gold": 53, "wood": 17, "stone": 15}, img: "assets/ui/rifugio/furniture/set08/01.png"},
        {id: "f072", name: "Torcia della Fiamma Spettrale", bonusText: "+1% Monete", epic: false, wall: false, effects: [{"type": "goldMult", "value": 0.01}], price: {"gold": 60, "wood": 19, "stone": 16}, img: "assets/ui/rifugio/furniture/set08/02.png"},
        {id: "f073", name: "Piano di Ossidiana", bonusText: "+1% XP Corsa", epic: false, wall: false, effects: [{"type": "xpMult", "activity": "corsa", "value": 0.01}], price: {"gold": 67, "wood": 21, "stone": 18}, img: "assets/ui/rifugio/furniture/set08/03.png"},
        {id: "f074", name: "Sgabello di Pietra Pomice", bonusText: "+1 Stamina", epic: false, wall: false, effects: [{"type": "staminaMax", "value": 1.0}], price: {"gold": 74, "wood": 24, "stone": 20}, img: "assets/ui/rifugio/furniture/set08/04.png"},
        {id: "f075", name: "Ramo Secco del Deserto", bonusText: "+1% Danni Arena", epic: false, wall: true, effects: [{"type": "arenaDmgMult", "value": 0.01}], price: {"gold": 81, "wood": 37, "stone": 48}, img: "assets/ui/rifugio/furniture/set08/05.png"},
        {id: "f076", name: "Rotolo delle Dune Annerito", bonusText: "+1% XP Camminata", epic: false, wall: true, effects: [{"type": "xpMult", "activity": "camminata", "value": 0.01}], price: {"gold": 88, "wood": 40, "stone": 52}, img: "assets/ui/rifugio/furniture/set08/06.png"},
        {id: "f077", name: "Teschio del Deserto", bonusText: "+1 Stamina", epic: false, wall: false, effects: [{"type": "staminaMax", "value": 1.0}], price: {"gold": 95, "wood": 30, "stone": 26}, img: "assets/ui/rifugio/furniture/set08/07.png"},
        {id: "f078", name: "Pugnale Intagliato", bonusText: "+1% Probabilità drop Progetti", epic: false, wall: false, effects: [{"type": "dropProjectChance", "value": 0.01}], price: {"gold": 102, "wood": 32, "stone": 28}, img: "assets/ui/rifugio/furniture/set08/08.png"},
        {id: "f079", name: "Forziere Rinforzato", bonusText: "+1% Monete", epic: false, wall: false, effects: [{"type": "goldMult", "value": 0.01}], price: {"gold": 109, "wood": 35, "stone": 30}, img: "assets/ui/rifugio/furniture/set08/09.png"},
        {id: "f080", name: "Brace del Fuoco Eterno", bonusText: "+3 Stamina", epic: true, wall: false, effects: [{"type": "staminaMax", "value": 3.0}], price: {"gold": 347, "wood": 110, "stone": 95}, img: "assets/ui/rifugio/furniture/set08/10.png"},
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        {id: "f141", name: "Tappeto di Spore Soffici", bonusText: "+1% HP Arena", epic: false, wall: false, effects: [{"type": "arenaHpMult", "value": 0.01}], price: {"gold": 96, "wood": 30, "stone": 26}, img: "assets/ui/rifugio/furniture/set15/01.png"},
        {id: "f142", name: "Cappello di Fungo Luminescente", bonusText: "+1% HP Arena", epic: false, wall: false, effects: [{"type": "arenaHpMult", "value": 0.01}], price: {"gold": 108, "wood": 34, "stone": 29}, img: "assets/ui/rifugio/furniture/set15/02.png"},
        {id: "f143", name: "Fetta di Fungo Porcino (Tavolo)", bonusText: "+1% XP Camminata", epic: false, wall: false, effects: [{"type": "xpMult", "activity": "camminata", "value": 0.01}], price: {"gold": 121, "wood": 38, "stone": 33}, img: "assets/ui/rifugio/furniture/set15/03.png"},
        {id: "f144", name: "Fungo Velenoso (Sgabello)", bonusText: "+1% Danni Arena", epic: false, wall: false, effects: [{"type": "arenaDmgMult", "value": 0.01}], price: {"gold": 133, "wood": 42, "stone": 36}, img: "assets/ui/rifugio/furniture/set15/04.png"},
        {id: "f145", name: "Giardino Verticale di Micelio", bonusText: "+1% HP Arena", epic: false, wall: true, effects: [{"type": "arenaHpMult", "value": 0.01}], price: {"gold": 145, "wood": 66, "stone": 86}, img: "assets/ui/rifugio/furniture/set15/08.png"},
        {id: "f146", name: "Arazzo delle Spore", bonusText: "+1% Drop Progetti", epic: false, wall: true, effects: [{"type": "dropProjectChance", "value": 0.01}], price: {"gold": 158, "wood": 72, "stone": 93}, img: "assets/ui/rifugio/furniture/set15/09.png"},
        {id: "f147", name: "Miconide in Vaso (Creatura viva)", bonusText: "+2% HP Arena", epic: false, wall: false, effects: [{"type": "arenaHpMult", "value": 0.02}], price: {"gold": 170, "wood": 54, "stone": 46}, img: "assets/ui/rifugio/furniture/set15/07.png"},
        {id: "f148", name: "Mortaio per Unguenti", bonusText: "+1% HP Arena", epic: false, wall: false, effects: [{"type": "arenaHpMult", "value": 0.01}], price: {"gold": 183, "wood": 58, "stone": 50}, img: "assets/ui/rifugio/furniture/set15/06.png"},
        {id: "f149", name: "Cassa di Corteccia", bonusText: "+1% Legna", epic: false, wall: false, effects: [{"type": "woodMult", "value": 0.01}], price: {"gold": 195, "wood": 62, "stone": 53}, img: "assets/ui/rifugio/furniture/set15/05.png"},
        {id: "f150", name: "La Madre Spora", bonusText: "+5% HP Arena", epic: true, wall: false, effects: [{"type": "arenaHpMult", "value": 0.05}], price: {"gold": 622, "wood": 198, "stone": 170}, img: "assets/ui/rifugio/furniture/set15/10.png"},
      ],
    },
    {
      ...
      setBonusEffects: [{"type": "xpMult", "activity": "cyclette", "value": 0.15}],
      items: [
        {id: "f151", name: "Pavimento di Sabbia e Coralli", bonusText: "+0.5% XP Cyclette", epic: false, wall: false, effects: [{"type": "xpMult", "activity": "cyclette", "value": 0.005}], price: {"gold": 102, "wood": 32, "stone": 28}, img: "assets/ui/rifugio/furniture/set16/01.png"},
        {id: "f152", name: "Perla nell'Ostrica", bonusText: "+1% XP Cyclette", epic: false, wall: false, effects: [{"type": "xpMult", "activity": "cyclette", "value": 0.01}], price: {"gold": 115, "wood": 37, "stone": 31}, img: "assets/ui/rifugio/furniture/set16/02.png"},
        {id: "f153", name: "Timone su Piedistallo", bonusText: "+1% XP Cyclette", epic: false, wall: false, effects: [{"type": "xpMult", "activity": "cyclette", "value": 0.01}], price: {"gold": 128, "wood": 41, "stone": 35}, img: "assets/ui/rifugio/furniture/set16/03.png"},
        {id: "f154", name: "Torre di Coralli Colorati", bonusText: "+0.5% XP Cyclette", epic: false, wall: false, effects: [{"type": "xpMult", "activity": "cyclette", "value": 0.005}], price: {"gold": 141, "wood": 45, "stone": 39}, img: "assets/ui/rifugio/furniture/set16/04.png"},
        {id: "f155", name: "Rete da Pesca con Stelle Marine", bonusText: "+1% Danni Arena", epic: false, wall: true, effects: [{"type": "arenaDmgMult", "value": 0.01}], price: {"gold": 155, "wood": 70, "stone": 91}, img: "assets/ui/rifugio/furniture/set16/05.png"},
        {id: "f156", name: "Mappa dei Mari del Corallo", bonusText: "+2% Drop Rari", epic: false, wall: true, effects: [{"type": "dropRareChance", "value": 0.02}], price: {"gold": 168, "wood": 76, "stone": 99}, img: "assets/ui/rifugio/furniture/set16/06.png"},
        {id: "f157", name: "Nave in Bottiglia", bonusText: "+1% XP Cyclette", epic: false, wall: false, effects: [{"type": "xpMult", "activity": "cyclette", "value": 0.01}], price: {"gold": 181, "wood": 58, "stone": 49}, img: "assets/ui/rifugio/furniture/set16/07.png"},
        {id: "f158", name: "Cannocchiale in Ottone", bonusText: "+1% Drop Rari", epic: false, wall: false, effects: [{"type": "dropRareChance", "value": 0.01}], price: {"gold": 194, "wood": 62, "stone": 53}, img: "assets/ui/rifugio/furniture/set16/08.png"},
        {id: "f159", name: "Forziere del Fondale", bonusText: "+1% Monete", epic: false, wall: false, effects: [{"type": "goldMult", "value": 0.01}], price: {"gold": 208, "wood": 66, "stone": 57}, img: "assets/ui/rifugio/furniture/set16/09.png"},
        {id: "f160", name: "La Conchiglia dell'Aurora", bonusText: "+3% XP Cyclette", epic: true, wall: false, effects: [{"type": "xpMult", "activity": "cyclette", "value": 0.03}], price: {"gold": 661, "wood": 210, "stone": 180}, img: "assets/ui/rifugio/furniture/set16/10.png"},
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        {id: "f181", name: "Parquet dell'Archivio", bonusText: "+1% XP Globale", epic: false, wall: false, effects: [{"type": "xpMult", "activity": "global", "value": 0.01}], price: {"gold": 120, "wood": 38, "stone": 33}, img: "assets/ui/rifugio/furniture/set19/01.png"},
        {id: "f182", name: "Tomo Ardente", bonusText: "+1% Monete", epic: false, wall: false, effects: [{"type": "goldMult", "value": 0.01}], price: {"gold": 135, "wood": 43, "stone": 37}, img: "assets/ui/rifugio/furniture/set19/02.png"},
        {id: "f183", name: "Scrivania dell'Archivista", bonusText: "+1% Legna e Pietra", epic: false, wall: false, effects: [{"type": "woodMult", "value": 0.01}, {"type": "stoneMult", "value": 0.01}], price: {"gold": 151, "wood": 48, "stone": 41}, img: "assets/ui/rifugio/furniture/set19/03.png"},
        {id: "f184", name: "Poltrona in Pelle Antica", bonusText: "+1% XP Globale", epic: false, wall: false, effects: [{"type": "xpMult", "activity": "global", "value": 0.01}], price: {"gold": 167, "wood": 53, "stone": 45}, img: "assets/ui/rifugio/furniture/set19/04.png"},
        {id: "f185", name: "Libreria Incassata", bonusText: "+1% Difesa Arena", epic: false, wall: true, effects: [{"type": "arenaDefMult", "value": 0.01}], price: {"gold": 182, "wood": 83, "stone": 108}, img: "assets/ui/rifugio/furniture/set19/05.png"},
        {id: "f186", name: "Carta Stellare Incorniciata", bonusText: "+2% Drop Rari", epic: false, wall: true, effects: [{"type": "dropRareChance", "value": 0.02}], price: {"gold": 198, "wood": 90, "stone": 117}, img: "assets/ui/rifugio/furniture/set19/06.png"},
        {id: "f187", name: "Globo d'Oro Antico", bonusText: "+1% HP Arena", epic: false, wall: false, effects: [{"type": "arenaHpMult", "value": 0.01}], price: {"gold": 213, "wood": 68, "stone": 58}, img: "assets/ui/rifugio/furniture/set19/07.png"},
        {id: "f188", name: "Penna dell'Archivista", bonusText: "+1% Drop Progetti", epic: false, wall: false, effects: [{"type": "dropProjectChance", "value": 0.01}], price: {"gold": 229, "wood": 73, "stone": 62}, img: "assets/ui/rifugio/furniture/set19/08.png"},
        {id: "f189", name: "Cassetta di Libri Rari", bonusText: "+1% Monete", epic: false, wall: false, effects: [{"type": "goldMult", "value": 0.01}], price: {"gold": 245, "wood": 78, "stone": 67}, img: "assets/ui/rifugio/furniture/set19/09.png"},
        {id: "f190", name: "Il Grande Tomo dell'Eclissi", bonusText: "+3% Drop Rari e +1 Stamina", epic: true, wall: false, effects: [{"type": "dropRareChance", "value": 0.03}, {"type": "staminaMax", "value": 1}], price: {"gold": 779, "wood": 248, "stone": 213}, img: "assets/ui/rifugio/furniture/set19/10.png"},
      ],
    },
    {
