...
const RPG = (() => {
  ...
  const DRAGON_CARDS = [
    // ── IGNIS — drago del fuoco (offensivo) ─────────────────────
    { id:'dc_ignis_c1',    dragon:'ignis',   type:'offensiva', rarity:'comune',      name:'Zanna di Fuoco',            icon:'🔥', atk:3, def:0, heal:0, desc:'Infligge 3 danni.' },
    { id:'dc_ignis_c2',    dragon:'ignis',   type:'offensiva', rarity:'comune',      name:'Braci Vive',                icon:'🔥', atk:2, def:0, heal:0, effect:'burn', effectVal:1, desc:'2 danni + 1 bruciatura al prossimo turno.' },
    { id:'dc_ignis_nc1',   dragon:'ignis',   type:'offensiva', rarity:'non_comune',  name:'Artiglio Ardente',          icon:'🔥', atk:4, def:0, heal:0, desc:'Infligge 4 danni.' },
    { id:'dc_ignis_nc2',   dragon:'ignis',   type:'offensiva', rarity:'non_comune',  name:'Soffio di Brace',           icon:'🔥', atk:3, def:0, heal:0, effect:'burn', effectVal:2, desc:'3 danni + 2 bruciatura.' },
    { id:'dc_ignis_r1',    dragon:'ignis',   type:'offensiva', rarity:'raro',        name:'Ruggito Infuocato',         icon:'🌋', atk:5, def:0, heal:0, desc:'Infligge 5 danni.' },
    { id:'dc_ignis_r2',    dragon:'ignis',   type:'offensiva', rarity:'raro',        name:'Esplosione Solare',         icon:'🌋', atk:4, def:1, heal:0, desc:'4 danni e assorbe 1.' },
    { id:'dc_ignis_e1',    dragon:'ignis',   type:'offensiva', rarity:'epico',       name:'Nova Cremante',             icon:'💥', atk:4, def:0, heal:0, effect:'burn', effectVal:2, desc:'4 danni + 2 bruciatura per 2 turni.' },
    { id:'dc_ignis_e2',    dragon:'ignis',   type:'offensiva', rarity:'epico',       name:'Tempesta di Fuoco',         icon:'💥', atk:6, def:0, heal:0, desc:'6 danni devastanti.' },
    { id:'dc_ignis_l1',    dragon:'ignis',   type:'offensiva', rarity:'leggendario', name:'Eruzione del Drago Eterno', icon:'🌋', atk:8, def:0, heal:0, effect:'burn', effectVal:4, desc:'8 danni + 4 bruciatura per 2 turni.' },
    { id:'dc_ignis_l2',    dragon:'ignis',   type:'offensiva', rarity:'leggendario', name:'Apocalisse di Cenere',      icon:'💥', atk:5, def:0, heal:0, effect:'double', desc:'5 danni due volte + bruciatura su entrambi i colpi.' },
    // ── AQUA — drago dell'acqua (difensivo) ─────────────────────
    { id:'dc_aqua_c1',     dragon:'aqua',    type:'difensiva', rarity:'comune',      name:'Scudo d\'Acqua',            icon:'🛡️', atk:0, def:4, heal:0, desc:'Assorbe 4 danni.' },
    { id:'dc_aqua_c2',     dragon:'aqua',    type:'difensiva', rarity:'comune',      name:'Goccia Curativa',           icon:'💧', atk:0, def:0, heal:2, desc:'Recupera 2 HP.' },
    { id:'dc_aqua_nc1',    dragon:'aqua',    type:'difensiva', rarity:'non_comune',  name:'Bolla Protettiva',          icon:'💧', atk:0, def:3, heal:1, desc:'Assorbe 3 danni e recupera 1 HP.' },
    { id:'dc_aqua_nc2',    dragon:'aqua',    type:'difensiva', rarity:'non_comune',  name:'Corrente Fredda',           icon:'💧', atk:0, def:0, heal:3, desc:'Recupera 3 HP.' },
    { id:'dc_aqua_r1',     dragon:'aqua',    type:'difensiva', rarity:'raro',        name:'Marea Protettiva',          icon:'🌊', atk:0, def:4, heal:2, desc:'Assorbe 4 danni e recupera 2 HP.' },
    { id:'dc_aqua_r2',     dragon:'aqua',    type:'difensiva', rarity:'raro',        name:'Onda Purificante',          icon:'🌊', atk:0, def:0, heal:5, effect:'cleanse', desc:'Recupera 5 HP e rimuove tutti gli effetti negativi.' },
    { id:'dc_aqua_e1',     dragon:'aqua',    type:'difensiva', rarity:'epico',       name:'Vortice Guaritore',         icon:'💎', atk:0, def:3, heal:3, desc:'Assorbe 3 danni e recupera 3 HP.' },
    { id:'dc_aqua_e2',     dragon:'aqua',    type:'difensiva', rarity:'epico',       name:'Scudo Abissale',            icon:'💎', atk:0, def:7, heal:0, desc:'Assorbe 7 danni.' },
    { id:'dc_aqua_l1',     dragon:'aqua',    type:'difensiva', rarity:'leggendario', name:'Diluvio Rigenerante',       icon:'🌊', atk:0, def:6, heal:6, effect:'shield', desc:'Assorbe 6 danni, recupera 6 HP e crea uno scudo per il turno successivo.' },
    { id:'dc_aqua_l2',     dragon:'aqua',    type:'difensiva', rarity:'leggendario', name:'Oceano Immortale',          icon:'💎', atk:0, def:0, heal:8, effect:'revive', desc:'Recupera 8 HP. Se sei sconfitto questo turno, sopravvivi con 1 HP.' },
    // ── SILVANO — drago della foresta (supporto) ─────────────────
    { id:'dc_silvano_c1',  dragon:'silvano', type:'supporto',  rarity:'comune',      name:'Vento Verde',               icon:'🌿', atk:0, def:0, heal:2, desc:'Recupera 2 HP.' },
    { id:'dc_silvano_c2',  dragon:'silvano', type:'supporto',  rarity:'comune',      name:'Foglia Guida',              icon:'🍃', atk:0, def:0, heal:0, effect:'draw', effectVal:1, desc:'Pesca 1 carta.' },
    { id:'dc_silvano_nc1', dragon:'silvano', type:'supporto',  rarity:'non_comune',  name:'Spore Curative',            icon:'🍃', atk:0, def:0, heal:3, desc:'Recupera 3 HP.' },
    { id:'dc_silvano_nc2', dragon:'silvano', type:'supporto',  rarity:'non_comune',  name:'Intrico Radicale',          icon:'🌿', atk:1, def:0, heal:2, desc:'1 danno e recupera 2 HP.' },
    { id:'dc_silvano_r1',  dragon:'silvano', type:'supporto',  rarity:'raro',        name:'Linfa Vitale',              icon:'🌳', atk:1, def:0, heal:4, desc:'1 danno e recupera 4 HP.' },
    { id:'dc_silvano_r2',  dragon:'silvano', type:'supporto',  rarity:'raro',        name:'Rigenerazione Boschiva',    icon:'🌳', atk:0, def:0, heal:4, effect:'draw', effectVal:1, desc:'Recupera 4 HP e pesca 1 carta.' },
    { id:'dc_silvano_e1',  dragon:'silvano', type:'supporto',  rarity:'epico',       name:'Fioritura Eterna',          icon:'🌸', atk:0, def:0, heal:0, effect:'draw', effectVal:2, desc:'Pesca 2 carte extra.' },
    { id:'dc_silvano_e2',  dragon:'silvano', type:'supporto',  rarity:'epico',       name:'Guarigione del Grande Albero',icon:'🌸', atk:0, def:2, heal:6, desc:'Recupera 6 HP e assorbe 2 danni.' },
    { id:'dc_silvano_l1',  dragon:'silvano', type:'supporto',  rarity:'leggendario', name:'Rinascita del Grande Bosco', icon:'🌲', atk:2, def:0, heal:8, effect:'draw', effectVal:2, desc:'2 danni, recupera 8 HP e pesca 2 carte.' },
    { id:'dc_silvano_l2',  dragon:'silvano', type:'supporto',  rarity:'leggendario', name:'Spirito della Foresta',     icon:'🌲', atk:0, def:5, heal:5, effect:'draw', effectVal:3, desc:'Recupera 5 HP, assorbe 5 danni e pesca 3 carte.' },
    // ── TERRAS — drago della terra (difensivo/offensivo) ─────────
    { id:'dc_terras_c1',   dragon:'terras',  type:'difensiva', rarity:'comune',      name:'Muro di Roccia',            icon:'🪨', atk:0, def:5, heal:0, desc:'Assorbe 5 danni.' },
    { id:'dc_terras_c2',   dragon:'terras',  type:'offensiva', rarity:'comune',      name:'Polvere di Pietra',         icon:'🪨', atk:2, def:1, heal:0, desc:'2 danni e assorbe 1.' },
    { id:'dc_terras_nc1',  dragon:'terras',  type:'difensiva', rarity:'non_comune',  name:'Scudo di Granito',          icon:'🪨', atk:0, def:3, heal:1, desc:'Assorbe 3 danni e recupera 1 HP.' },
    { id:'dc_terras_nc2',  dragon:'terras',  type:'offensiva', rarity:'non_comune',  name:'Impatto Tellurico',         icon:'⛏️', atk:3, def:0, heal:0, desc:'Infligge 3 danni.' },
    { id:'dc_terras_r1',   dragon:'terras',  type:'offensiva', rarity:'raro',        name:'Pugno di Terra',            icon:'⛏️', atk:4, def:2, heal:0, desc:'4 danni e assorbe 2.' },
    { id:'dc_terras_r2',   dragon:'terras',  type:'difensiva', rarity:'raro',        name:'Terremoto Minore',          icon:'🏔️', atk:3, def:3, heal:0, desc:'3 danni e assorbe 3.' },
    { id:'dc_terras_e1',   dragon:'terras',  type:'difensiva', rarity:'epico',       name:'Fortezza Ancestrale',       icon:'🏔️', atk:0, def:8, heal:0, desc:'Assorbe 8 danni.' },
    { id:'dc_terras_e2',   dragon:'terras',  type:'offensiva', rarity:'epico',       name:'Valanga',                   icon:'⛏️', atk:5, def:0, heal:0, effect:'stun', desc:'5 danni. Stordisce il nemico per un turno.' },
    { id:'dc_terras_l1',   dragon:'terras',  type:'difensiva', rarity:'leggendario', name:'Colosso di Pietra Eterna',  icon:'🏔️', atk:3, def:10, heal:0, effect:'taunt', desc:'3 danni, assorbe 10 danni e forza il nemico ad attaccare per un turno.' },
    { id:'dc_terras_l2',   dragon:'terras',  type:'offensiva', rarity:'leggendario', name:'Apocalisse Geologica',      icon:'⛏️', atk:6, def:6, heal:0, desc:'6 danni e assorbe 6.' },
    // ── GLACIO — drago del ghiaccio (offensivo/control) ──────────
    { id:'dc_glacio_c1',   dragon:'glacio',  type:'offensiva', rarity:'comune',      name:'Lama di Ghiaccio',          icon:'❄️', atk:2, def:0, heal:0, effect:'freeze', effectVal:1, desc:'2 danni. Il nemico perde 1 difesa.' },
    { id:'dc_glacio_c2',   dragon:'glacio',  type:'offensiva', rarity:'comune',      name:'Cristallo Pungente',        icon:'🧊', atk:3, def:0, heal:0, desc:'Infligge 3 danni.' },
    { id:'dc_glacio_nc1',  dragon:'glacio',  type:'offensiva', rarity:'non_comune',  name:'Freccia Glaciale',          icon:'🧊', atk:3, def:0, heal:0, desc:'Infligge 3 danni.' },
    { id:'dc_glacio_nc2',  dragon:'glacio',  type:'difensiva', rarity:'non_comune',  name:'Nebbia Gelida',             icon:'❄️', atk:0, def:2, heal:0, effect:'freeze', effectVal:1, desc:'Assorbe 2 danni. Il nemico perde 1 difesa.' },
    { id:'dc_glacio_r1',   dragon:'glacio',  type:'offensiva', rarity:'raro',        name:'Tempesta Glaciale',         icon:'🌨️', atk:4, def:0, heal:0, effect:'freeze', effectVal:2, desc:'4 danni. Il nemico perde 2 difesa.' },
    { id:'dc_glacio_r2',   dragon:'glacio',  type:'offensiva', rarity:'raro',        name:'Lancia di Ghiaccio',        icon:'🧊', atk:5, def:0, heal:0, desc:'Infligge 5 danni.' },
    { id:'dc_glacio_e1',   dragon:'glacio',  type:'offensiva', rarity:'epico',       name:'Congelamento Totale',       icon:'🧊', atk:3, def:0, heal:0, effect:'stun', desc:'3 danni. Il nemico salta il prossimo turno.' },
    { id:'dc_glacio_e2',   dragon:'glacio',  type:'offensiva', rarity:'epico',       name:'Tormenta Eterna',           icon:'🌨️', atk:4, def:3, heal:0, effect:'freeze', effectVal:2, desc:'4 danni, assorbe 3 e abbassa 2 difesa nemica.' },
    { id:'dc_glacio_l1',   dragon:'glacio',  type:'offensiva', rarity:'leggendario', name:'Era Glaciale',              icon:'❄️', atk:5, def:0, heal:0, effect:'stun', desc:'5 danni. Stordisce il nemico per 2 turni e azzera la sua difesa.' },
    { id:'dc_glacio_l2',   dragon:'glacio',  type:'offensiva', rarity:'leggendario', name:'Assoluto Zero',             icon:'🧊', atk:7, def:0, heal:0, effect:'freeze', effectVal:5, desc:'7 danni. Azzera la difesa nemica e la congela per 2 turni.' },
    // ── VOLT — drago del fulmine (offensivo/veloce) ───────────────
    { id:'dc_volt_c1',     dragon:'volt',    type:'offensiva', rarity:'comune',      name:'Scintilla',                 icon:'⚡', atk:4, def:0, heal:0, desc:'Infligge 4 danni.' },
    { id:'dc_volt_c2',     dragon:'volt',    type:'offensiva', rarity:'comune',      name:'Scosse Statiche',           icon:'⚡', atk:2, def:0, heal:0, effect:'chain', desc:'2 danni che rimbalzano e infliggono 1 danno extra.' },
    { id:'dc_volt_nc1',    dragon:'volt',    type:'offensiva', rarity:'non_comune',  name:'Elettroschoc',              icon:'⚡', atk:3, def:0, heal:0, effect:'stun', desc:'3 danni. 50% di stordire il nemico.' },
    { id:'dc_volt_nc2',    dragon:'volt',    type:'offensiva', rarity:'non_comune',  name:'Scarica Rapida',            icon:'⚡', atk:4, def:0, heal:0, desc:'Infligge 4 danni con priorità (va prima del nemico).' },
    { id:'dc_volt_r1',     dragon:'volt',    type:'offensiva', rarity:'raro',        name:'Fulmine Diretto',           icon:'🌩️', atk:6, def:0, heal:0, desc:'Infligge 6 danni.' },
    { id:'dc_volt_r2',     dragon:'volt',    type:'offensiva', rarity:'raro',        name:'Tempesta Elettrica',        icon:'🌩️', atk:3, def:0, heal:0, effect:'double', desc:'Infligge 3 danni due volte.' },
    { id:'dc_volt_e1',     dragon:'volt',    type:'offensiva', rarity:'epico',       name:'Scarica Sovraccarica',      icon:'🔋', atk:3, def:0, heal:0, effect:'double', desc:'3 danni due volte. Il secondo colpo ignora la difesa.' },
    { id:'dc_volt_e2',     dragon:'volt',    type:'offensiva', rarity:'epico',       name:'Arco Voltaico',             icon:'⚡', atk:5, def:0, heal:0, effect:'chain', desc:'5 danni che rimbalzano infliggendo 3 danni extra.' },
    { id:'dc_volt_l1',     dragon:'volt',    type:'offensiva', rarity:'leggendario', name:'Tempesta Suprema',          icon:'🌩️', atk:7, def:0, heal:0, effect:'chain', desc:'7 danni che rimbalzano tre volte (7+5+3+1).' },
    { id:'dc_volt_l2',     dragon:'volt',    type:'offensiva', rarity:'leggendario', name:'Dio del Tuono',             icon:'🔋', atk:6, def:0, heal:0, effect:'double+stun', desc:'6 danni due volte. Stordisce il nemico dopo il secondo colpo.' },
    // ── UMBRA — drago dell'ombra (control/supporto) ───────────────
    { id:'dc_umbra_c1',    dragon:'umbra',   type:'difensiva', rarity:'comune',      name:'Velo Oscuro',               icon:'🌑', atk:0, def:3, heal:0, desc:'Assorbe 3 danni.' },
    { id:'dc_umbra_c2',    dragon:'umbra',   type:'supporto',  rarity:'comune',      name:'Sussurro delle Ombre',      icon:'🌑', atk:1, def:2, heal:0, desc:'1 danno e assorbe 2.' },
    { id:'dc_umbra_nc1',   dragon:'umbra',   type:'supporto',  rarity:'non_comune',  name:'Tocco d\'Ombra',            icon:'🌑', atk:2, def:1, heal:0, desc:'2 danni e assorbe 1.' },
    { id:'dc_umbra_nc2',   dragon:'umbra',   type:'supporto',  rarity:'non_comune',  name:'Nebbia Oscura',             icon:'🌑', atk:0, def:3, heal:0, effect:'blind', desc:'Assorbe 3 danni. Il nemico manca il prossimo attacco.' },
    { id:'dc_umbra_r1',    dragon:'umbra',   type:'supporto',  rarity:'raro',        name:'Drenaggio Vitale',          icon:'🕷️', atk:3, def:0, heal:3, desc:'3 danni e recupera 3 HP.' },
    { id:'dc_umbra_r2',    dragon:'umbra',   type:'offensiva', rarity:'raro',        name:'Lama d\'Ombra',             icon:'👁️', atk:4, def:2, heal:0, desc:'4 danni e assorbe 2.' },
    { id:'dc_umbra_e1',    dragon:'umbra',   type:'supporto',  rarity:'epico',       name:'Furto di Potere',           icon:'👁️', atk:2, def:0, heal:0, effect:'steal', desc:'2 danni e ruba 1 carta dalla mano nemica.' },
    { id:'dc_umbra_e2',    dragon:'umbra',   type:'supporto',  rarity:'epico',       name:'Cancellazione Oscura',      icon:'🕷️', atk:3, def:0, heal:3, effect:'steal', desc:'3 danni, recupera 3 HP e ruba 1 carta.' },
    { id:'dc_umbra_l1',    dragon:'umbra',   type:'supporto',  rarity:'leggendario', name:'Sovrano delle Ombre',       icon:'👁️', atk:4, def:0, heal:4, effect:'steal', desc:'4 danni, recupera 4 HP e ruba 2 carte dalla mano nemica.' },
    { id:'dc_umbra_l2',    dragon:'umbra',   type:'supporto',  rarity:'leggendario', name:'Abisso Divorante',          icon:'🌑', atk:5, def:5, heal:0, effect:'blind+steal', desc:'5 danni, assorbe 5, acceca il nemico e ruba 1 carta.' },
    // ── CHRONOS — drago del tempo (control) ──────────────────────
    { id:'dc_chronos_c1',  dragon:'chronos', type:'supporto',  rarity:'comune',      name:'Rallentamento',             icon:'⏳', atk:0, def:0, heal:0, effect:'slow', desc:'Il nemico perde 1 azione al prossimo turno.' },
    { id:'dc_chronos_c2',  dragon:'chronos', type:'difensiva', rarity:'comune',      name:'Pausa Momentanea',          icon:'⌛', atk:0, def:2, heal:0, effect:'slow', desc:'Assorbe 2 danni e rallenta il nemico.' },
    { id:'dc_chronos_nc1', dragon:'chronos', type:'supporto',  rarity:'non_comune',  name:'Distorsione',               icon:'⌛', atk:1, def:0, heal:1, desc:'1 danno e recupera 1 HP.' },
    { id:'dc_chronos_nc2', dragon:'chronos', type:'supporto',  rarity:'non_comune',  name:'Accelerazione',             icon:'⏳', atk:2, def:0, heal:0, effect:'draw', effectVal:1, desc:'2 danni e pesca 1 carta.' },
    { id:'dc_chronos_r1',  dragon:'chronos', type:'supporto',  rarity:'raro',        name:'Riavvolgimento',            icon:'🔄', atk:0, def:0, heal:0, effect:'rewind', desc:'Riprendi l\'ultima carta giocata e giocala di nuovo.' },
    { id:'dc_chronos_r2',  dragon:'chronos', type:'supporto',  rarity:'raro',        name:'Salto Temporale',           icon:'⌛', atk:0, def:0, heal:0, effect:'extra_turn', desc:'Gioca un\'altra carta subito dopo questa.' },
    { id:'dc_chronos_e1',  dragon:'chronos', type:'supporto',  rarity:'epico',       name:'Doppio Turno',              icon:'⌛', atk:0, def:0, heal:0, effect:'extra_turn', desc:'Gioca due carte extra questo turno.' },
    { id:'dc_chronos_e2',  dragon:'chronos', type:'supporto',  rarity:'epico',       name:'Paradosso',                 icon:'🔄', atk:0, def:0, heal:0, effect:'rewind+draw', effectVal:2, desc:'Riprendi l\'ultima carta giocata e pesca 2 carte.' },
    { id:'dc_chronos_l1',  dragon:'chronos', type:'supporto',  rarity:'leggendario', name:'Padrone del Tempo',         icon:'⏳', atk:0, def:0, heal:0, effect:'time_stop', effectVal:2, desc:'Il nemico salta 2 turni. Tu peschi 3 carte.' },
    { id:'dc_chronos_l2',  dragon:'chronos', type:'supporto',  rarity:'leggendario', name:'Singolarità Temporale',     icon:'🔄', atk:0, def:0, heal:0, effect:'time_stop+rewind', desc:'Nemico salta 2 turni. Riprendi tutte le carte giocate questo turno.' },
    // ── LUX — drago della luce (supporto/sacro) ──────────────────
    { id:'dc_lux_c1',      dragon:'lux',     type:'supporto',  rarity:'comune',      name:'Raggio di Sole',            icon:'☀️', atk:0, def:0, heal:2, desc:'Recupera 2 HP.' },
    { id:'dc_lux_c2',      dragon:'lux',     type:'offensiva', rarity:'comune',      name:'Scintilla Sacra',           icon:'✨', atk:2, def:0, heal:0, desc:'Infligge 2 danni sacri.' },
    { id:'dc_lux_nc1',     dragon:'lux',     type:'supporto',  rarity:'non_comune',  name:'Benedizione',               icon:'✨', atk:0, def:1, heal:3, desc:'Assorbe 1 danno e recupera 3 HP.' },
    { id:'dc_lux_nc2',     dragon:'lux',     type:'offensiva', rarity:'non_comune',  name:'Lampo Accecante',           icon:'☀️', atk:2, def:0, heal:0, effect:'blind', desc:'2 danni sacri. Il nemico manca il prossimo attacco.' },
    { id:'dc_lux_r1',      dragon:'lux',     type:'supporto',  rarity:'raro',        name:'Guarigione Divina',         icon:'✨', atk:0, def:0, heal:5, desc:'Recupera 5 HP.' },
    { id:'dc_lux_r2',      dragon:'lux',     type:'offensiva', rarity:'raro',        name:'Lancia di Luce',            icon:'☀️', atk:5, def:0, heal:0, desc:'Infligge 5 danni sacri che ignorano la difesa.' },
    { id:'dc_lux_e1',      dragon:'lux',     type:'supporto',  rarity:'epico',       name:'Rinascita della Fenice',    icon:'✨', atk:0, def:0, heal:6, effect:'revive', desc:'Recupera 6 HP. 50% di sopravvivere a un KO questo turno.' },
    { id:'dc_lux_e2',      dragon:'lux',     type:'offensiva', rarity:'epico',       name:'Giudizio Solare',           icon:'☀️', atk:6, def:0, heal:0, effect:'cleanse', desc:'6 danni sacri e rimuove tutti gli effetti negativi su di te.' },
    { id:'dc_lux_l1',      dragon:'lux',     type:'supporto',  rarity:'leggendario', name:'Sole Eterno',               icon:'☀️', atk:4, def:0, heal:8, effect:'blind', desc:'4 danni sacri, recupera 8 HP e acceca il nemico per 2 turni.' },
    { id:'dc_lux_l2',      dragon:'lux',     type:'supporto',  rarity:'leggendario', name:'Avatara della Luce',        icon:'✨', atk:5, def:5, heal:5, effect:'revive', desc:'5 danni sacri, assorbe 5, recupera 5 HP. Sopravvivi al prossimo KO.' },
    // ── AERO — drago del vento (agile/control) ────────────────────
    { id:'dc_aero_c1',     dragon:'aero',    type:'offensiva', rarity:'comune',      name:'Raffica',                   icon:'💨', atk:3, def:0, heal:0, desc:'Infligge 3 danni.' },
    { id:'dc_aero_c2',     dragon:'aero',    type:'supporto',  rarity:'comune',      name:'Vento Curativo',            icon:'💨', atk:0, def:0, heal:2, desc:'Recupera 2 HP.' },
    { id:'dc_aero_nc1',    dragon:'aero',    type:'offensiva', rarity:'non_comune',  name:'Tornado Minore',            icon:'🌪️', atk:3, def:0, heal:0, effect:'discard', desc:'3 danni. Il nemico scarta 1 carta a caso dalla mano.' },
    { id:'dc_aero_nc2',    dragon:'aero',    type:'supporto',  rarity:'non_comune',  name:'Corrente Ascensionale',     icon:'💨', atk:0, def:0, heal:0, effect:'draw', effectVal:2, desc:'Pesca 2 carte.' },
    { id:'dc_aero_r1',     dragon:'aero',    type:'offensiva', rarity:'raro',        name:'Turbine Tagliente',         icon:'🌪️', atk:4, def:0, heal:0, effect:'double', desc:'4 danni due volte (attacco rapido: sempre per primo).' },
    { id:'dc_aero_r2',     dragon:'aero',    type:'difensiva', rarity:'raro',        name:'Barriera di Vento',         icon:'💨', atk:0, def:5, heal:0, desc:'Assorbe 5 danni.' },
    { id:'dc_aero_e1',     dragon:'aero',    type:'offensiva', rarity:'epico',       name:'Occhio del Ciclone',        icon:'🌪️', atk:4, def:4, heal:0, effect:'discard', desc:'4 danni, assorbe 4 e il nemico scarta 1 carta.' },
    { id:'dc_aero_e2',     dragon:'aero',    type:'offensiva', rarity:'epico',       name:'Tempesta di Lame',          icon:'💨', atk:3, def:0, heal:0, effect:'double+chain', desc:'3 danni due volte che rimbalzano per 1 danno extra ciascuno.' },
    { id:'dc_aero_l1',     dragon:'aero',    type:'offensiva', rarity:'leggendario', name:'Grande Uragano',            icon:'🌪️', atk:6, def:0, heal:0, effect:'discard+stun', desc:'6 danni. Il nemico scarta 2 carte e salta il prossimo turno.' },
    { id:'dc_aero_l2',     dragon:'aero',    type:'supporto',  rarity:'leggendario', name:'Dio del Cielo',             icon:'💨', atk:5, def:5, heal:5, effect:'draw', effectVal:3, desc:'5 danni, assorbe 5, recupera 5 HP e pesca 3 carte. L\'equilibrio supremo.' },
  ];
